...
<div className="clubGridCon flex justify-center ml-10 mt-10">
    <div className="clubGrid">
        ...
        <br/>
        <br/>
        Nevertheless, we still scored each book and Josh took care of the book graphics which you can view in the <a target="_blank" href="/books/library" className="underline font-bold">book library</a>. It was then a matter of discussion what the next book would be. By 2024 we had read and scored 12 books, and had no plans in stopping. However, this created a problem. We had all this data of scores and graphics but it was only stored on our whatsapp group. This made it a nightmare if we wanted to review scores from years ago. Hence, I came up with the idea of creating a website, so that anytime, any one of us could visit this site.
        <br/>
        <br/>
        As I created a Fullstack application for this purpose, it meant anything was possible. For example, I could store the data as a json via a database platform and create my own API. With this API, I could manipulate the data however I saw fit, such as calculating our average rating, whether we read all the books and what were our best and most hated. I did just that, and you can view our stats, for example, <a target="_blank"  className="underline font-bold" href="/brothers/stats"> here</a>. Furthermore, I could add CRUD operations and user login, meaning we could rate the book and add another directly on the website. 
        <br/>
        <br/>
        This of course is just a small example of what is possible, and what I achieved so far on this website. We're always coming up with ideas and the more challenging, the better.
        <br/>
        I'm incredibly excited of what this could become!!
        <br/>
        <br/>
        ...
        <Image className="clubImageWide3" src={BerlinMeet2} alt="clubmeeting5" />
    </div>
</div>
)
}
