...
const Quiz: React.FC = () => {
  ...
  const quiz = {
    quiz: [
      {
        question:
          "Who is the protagonist and main character in 'Slaughterhouse-Five'?",
        options: [
          "Billy Pilgrim",
          "Holden Caulfield",
          "Winston Smith",
      ...
      {
        question:
          "What mystical element is a recurring theme throughout 'One Hundred Years of Solitude'?",
        options: [
          "Time travel",
          "Magical realism",
          "Telekinesis",
      ...
      {
        question:
          "Who is the ancient Chinese military strategist credited with 'The Art of War'?",
      ...
      {
        question:
          "Which city serves as the backdrop for the stories in 'Dubliner'?",
      ...
      {
        question: `You got ${counter} correct. ${
          counter > 7
            ? "Great job!🤓"
